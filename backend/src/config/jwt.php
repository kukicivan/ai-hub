...
return [
    ...
    */
    ...
    'ttl' => (int) env('JWT_TTL', 15), // 15 minutes for access token
    ...
    */
    ...
    'refresh_ttl' => (int) env('JWT_REFRESH_TTL', 20160), // 14 days for refresh token
    ...
    */
    ...
    'persistent_claims' => [
        // Add custom claims that persist through refresh
    ],
